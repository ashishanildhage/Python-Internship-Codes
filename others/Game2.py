#question is wrong understand the question
num=input("Enter Number from 0 to 100 : ")
min=0
max=100
count=3
if len(num)==1:
...
if 0<=num<=100:
    ...
    print(f"the number u entered is {ans},{min},{max}")
else:
...
#these are searching and sorting algorithm. ijstra, minimum spanning tree, game theory, find the best path
